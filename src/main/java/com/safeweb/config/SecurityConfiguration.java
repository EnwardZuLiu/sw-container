package com.safeweb.config;

import com.safeweb.security.AuthoritiesConstants;
import com.safeweb.security.jwt.JWTFilter;
import com.safeweb.security.jwt.TokenProvider;
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        http
            .securityMatcher(new NegatedServerWebExchangeMatcher(new OrServerWebExchangeMatcher(
                pathMatchers("/app/**", "/i18n/**", "/content/**", "/swagger-ui/**", "/static/**", "/test/**"),
